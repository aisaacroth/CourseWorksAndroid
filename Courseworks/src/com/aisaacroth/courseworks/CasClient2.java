...
public class CasClient2 {
	...
	//
	// /***************************************************************************
	// * Helper method to extract the LT from the login form received from
	// CAS.
	// *
	// * @param data
	...
	//
	// /***************************************************************************
	// * Implementing this method because there is an issue with the SSL
	// Peer
	// * certification. Necessary to set up because the test emulator does
	// not
	// * have a valid SSL certificate causing a
	// * javax.net.ssl.SSLPeerUnverifiedException to be thrown. TODO:
	// Document
	// * heavily.
	// *
	// * NOTE: REMOVE BEFORE PUSHING TO PRODUCTION CODE! THIS IS SOLEY FOR
	// TESTING
	// * PURPOSES!!!!!!!!!
	// *
	// * @param client
